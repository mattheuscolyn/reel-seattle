...
→ **[specs/home.md](./specs/home.md)** · **[specs/film-detail.md](./specs/film-detail.md)** · **[specs/planner.md](./specs/planner.md)** · **[specs/theater.md](./specs/theater.md)** · **[specs/explore-search.md](./specs/explore-search.md)** · **[specs/opportunity-expression.md](./specs/opportunity-expression.md)**
...
| Opportunity expression depth / actions | → [canonical Opportunity expression](./specs/opportunity-expression.md) (D-24); **no** standalone Opportunity Detail page |
...
### Opportunity expression (retired standalone detail)

> **Canonical specification:** [specs/opportunity-expression.md](./specs/opportunity-expression.md) (D-24)

**No standalone Opportunity Detail screen is planned.** An Opportunity is already the finest actionable grain (Film + Theater + Showtime + Presentation context). From that grain, users act, compare, or move to broader Film, Theater, Explore, or Planner context. Film Detail remains the primary film-decision destination. Opportunity is expressed contextually across canonical surfaces — not as a deeper page beneath Opportunity.
