...
**Related:** [README](./README.md) · [Editorial design language](./15-editorial-design-language.md) · [Entity expression](./16-entity-expression.md)
...
| [16 Entity expression](./16-entity-expression.md) | Philosophy documented (D-16); component mappings deferred |
