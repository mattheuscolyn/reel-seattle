...
| Home · inline expand | `Film Detail Overlay Example on Home Screen.png` | Yes | Home + `InlineQuickDetail` | **Medium–High** | **Production-backed** | Expand-first on shelves; Save/NI/meta thinner than mockup (enrichment suppressed). |
