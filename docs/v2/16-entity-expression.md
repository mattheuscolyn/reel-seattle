...
Home surfaces awareness; Film Detail builds confidence; Planner asks fit. All still refer to one Film. Canonical surfaces: [Home](./specs/home.md), [Film Detail](./specs/film-detail.md); conceptual overview: [Screen specifications](./08-screen-specifications.md).
