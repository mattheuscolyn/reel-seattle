...
| UI components / wireframes | → [Component system](./06-component-system.md); Home / Film Detail / Theater / Planner behavior → [Screen specifications](./08-screen-specifications.md) |
