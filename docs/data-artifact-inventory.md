...
| `docs/siff-minimal-alignment-design.md` | SIFF P-20A minimal alignment design | Design · implemented in P-20B |
| `docs/siff-minimal-alignment.md` | SIFF P-20B implementation notes + live validation | Implementation complete · rollout P-20C |
