...
export const BUILD_PLAN_MOCKUP_FIXTURE = Object.freeze({
  ...
  what: Object.freeze({
    step: 3,
    title: 'What?',
    support: 'Lock exact showtimes, then set film preferences.',
    manageLabel: 'Manage',
    lockedShowtimesLabel: 'Locked showtimes',
    addShowtimeLabel: 'Add a showtime',
    mustIncludeLabel: 'Must include',
    wouldLoveLabel: 'Would love to see',
    notInterestedLabel: 'Not interested in',
    addAnotherLabel: 'Add film',
    moreOptionsLabel: 'More options (format, theater, showtime)',
    ineligibleFilmHint: 'No showtimes match your current constraints',
    incompatibleLockHint: 'Doesn’t match your current constraints',
  }),
